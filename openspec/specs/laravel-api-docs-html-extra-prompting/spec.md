# laravel-api-docs-html-extra-prompting Specification

## Purpose
Define how guided-sync should discuss optional Redoc HTML extra content with the user before generating `extra.md`.

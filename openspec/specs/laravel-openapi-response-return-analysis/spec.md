# laravel-openapi-response-return-analysis Specification

## Purpose
Define how the generator derives OpenAPI response schema and examples from real controller return forms and project-specific wrappers.

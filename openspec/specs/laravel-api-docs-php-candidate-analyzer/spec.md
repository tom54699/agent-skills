# laravel-api-docs-php-candidate-analyzer Specification

## Purpose
TBD - created by archiving change rewrite-infer-candidates-as-php-analyzer. Update Purpose after archive.
## Requirements

...
- [x] 1.1 擴充 `skills/.curated/laravel-api-docs/scripts/upload-apidog.sh`，在 import 後重新 export remote OpenAPI。
...
- [x] 2.1 更新 `skills/.curated/laravel-api-docs/SKILL.md`，說明 Step 7 的成功條件包含 post-upload verification。
